...
MARKETS = {
    ...
    "cpi": MarketConfig(
        ...
        shortname_prefix="CPI_",
        layout=TableLayout(min_cols=5, volume_col=None, time_col=4),
    ),
    "pmi": MarketConfig(
        id="pmi",
        base_url=settings.ST_BASE_URL,
        start_path=settings.ST_START_PMI_QUOTE_URL,
        mic="MCRO",  
        instrument_type=InstrumentType.MACRO, 
    ...
    "pkb": MarketConfig(
        id="pkb",
        base_url=settings.ST_BASE_URL,
        start_path=settings.ST_START_PKB_QUOTE_URL,
        mic="MCRO",  
        instrument_type=InstrumentType.MACRO, 
        shortname_prefix="PKB_",
        layout=TableLayout(min_cols=5, volume_col=None, time_col=4),
    ),
    "unr": MarketConfig(
        id="unr",
        base_url=settings.ST_BASE_URL,
        start_path=settings.ST_START_UNR_QUOTE_URL,
        mic="MCRO",  
        instrument_type=InstrumentType.MACRO, 
        shortname_prefix="UNR_",
        layout=TableLayout(min_cols=5, volume_col=None, time_col=4),
    ),
